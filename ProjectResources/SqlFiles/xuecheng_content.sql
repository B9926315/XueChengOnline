...
--
-- Host: 43.143.246.214    Database: xuecheng_content
-- ------------------------------------------------------
...
CREATE TABLE `course_base` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='课程基本信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `course_market` (`id`, `charge`, `price`, `original_price`, `qq`, `wechat`, `phone`, `valid_days`) VALUES (1,'201001',20.00,110.00,'11213','115156','115615',365),(2,'201000',1.00,11111.00,'2222','3333','4444',555),(18,'201001',11.00,111.00,'123456','654321','13333333',365),(22,'201001',11.00,1111.00,'334455','223321','1333333',33),(25,'201001',222.00,2222.00,'323232','323232','323232',365),(28,'201001',14.00,25.00,'42','24','242424',365),(40,'201001',11.00,1111.00,NULL,NULL,NULL,NULL),(74,'201001',1.00,100.00,'123456','654321','1333333',365),(82,'201001',22.00,222.00,'22','33','33',33),(84,'201001',11.00,11111.00,'11','11','22',22),(117,'201001',1.00,198.00,'24965575','24965575','24965575',365),(118,'201001',10.00,100.00,'43232','4324322','432432',365),(120,'201001',111.00,11.00,'432432','432432','43242',365),(121,'201001',1.00,100.00,'2323232','3232432','432432',365),(122,'201001',3.00,100.00,'156156','25165','1515',365);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='课程-教师关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dictionary` (
  ...
  `name` mediumtext,
  `code` mediumtext,
  `item_values` mediumtext
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='数据字典';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teachplan` (
  ...
  `change_date` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=296 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='课程计划';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-24 16:05:03
